...
def make_BUTTON_with_image_and_pack_it(name: str, frame: Canvas, image: Image, function, relx: float, rely: float)\
        -> None:
...
def make_LABEL_with_image_and_pack_it(name: str, frame: Canvas, image: Image, relx: float, rely: float, tag=None) ->\
        None:
